...
import com.dong.mianshiya.model.dto.questionbank.QuestionBankAddRequest;
import com.dong.mianshiya.model.dto.questionbank.QuestionBankEditRequest;
import com.dong.mianshiya.model.dto.questionbank.QuestionBankQueryRequest;
import com.dong.mianshiya.model.dto.questionbank.QuestionBankUpdateRequest;
...
import com.dong.mianshiya.model.vo.QuestionBankVO;
...
public class QuestionBankController {
    ...
    public BaseResponse<QuestionBankVO> getQuestionBankVOById(QuestionBankQueryRequest questionBankQueryRequest, HttpServletRequest request) {
        ...
        //是否查询题目
        Boolean needQueryQuestion = questionBankQueryRequest.isNeedQueryQuestionList();
     ...
     * 限流：提示“系统压力过大，请耐心等待”
     * 这里blockException的优先级会更高，如果和fallback一起配置
     * 那么当触发熔断导致的异常时，也会进入到这里进行限流处理
     * 因此，需要在这里做一个转发，将熔断的异常转发给fallback
     */
